...
<p align="center"><a href="">Traditional Chinese | Japanese</p>
...
Among DOMAINthem , you need to fill in the domain name you need to bind, and you need CONFIG_FILEto fill in the path of your configuration file.

The domain name of the heroku app is appname.herokuapp.com. The configuration file in the project is ./config/config.yaml

> heroku app域名为appname.herokuapp.com。项目内配置文件为./config/config.yaml

For the configuration file template, see the config/config.yamlfile , and the optional fields can be left blank. See the configuration file description for full configuration options .

](https://github.com/andatoshiki/toshiki-proxypool/wiki/%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)。
